...
module "vault-policies" {
  source                  = "git::https://github.com/bitrockteam/caravan-vault//modules/default-policies?ref=refs/tags/v0.3.23"
...
module "consul-backend" {
  source         = "git::https://github.com/bitrockteam/caravan-vault//modules/vault-consul-config?ref=refs/tags/v0.3.23"
  consul_address = var.consul_internal_address
  ca_cert        = var.ca_cert_file != null ? file(var.ca_cert_file) : null
  enable_nomad   = var.enable_nomad
}
...
module "authenticate" {
  ...
  source = "git::https://github.com/bitrockteam/caravan-vault//modules/vault-authentication?ref=refs/tags/v0.3.23"
